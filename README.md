...
Здесь аббревиатура [GUI](https://ru.wikipedia.org/wiki/Графический_интерфейс_пользователя) - графический интерфейс пользователя (graphical user interface), т.е. оконнный интерфейс операционной системы интуитивно похожий на Windows. Одним из распространённых вариантов GUI для Linux подобных операционных систем, является (GUI) [GNOME](https://ru.wikipedia.org/wiki/GNOME).
