...
> [!NOTE]
> _**Примечание:**_
> _Авторизация в браузере будет произведена в текущем активном аккаунте Яндекс ID. Иначе говоря вы подключите тот экземпляр Яндекс Диска, который привязан к вашему текущему активному аккаунту. Если вам нужен другой экземпляр Яндекс Диска, то измените текущий активнй аккаунт путём авторизации в нужном аккаунте._
