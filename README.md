...
```
> Здесь:
> _**davs**_ - префикс протокола подключения;
> 
> _**Имя_вашего_аккаунта**_ - имя <a href="#acc_create">аккаунта</a> зарегистрированное вами в Яндекс ID;
> 
> _**webdav.yandex.ru**_ - сетевое местоположения сервиса Яндекс Диска.
