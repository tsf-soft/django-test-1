...
На панели инструментов GUI нажмите на соответствующий значёк (на <a href="#fig31">рис. 3.1</a> значёк обведен красной рамкой). Все дальнейшие действия будут проводится с использованием открывшегося окна приложения "Файлы".
