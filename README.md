...
Команда `yandex-disk setup` запустит утилиту настройки (рис. 4.2). Утилита поставит перед пользователем ряд нтерактивных вопросов. Если в ответ на эти вопросы ничего не вводить, то будут приняты значения по умолчанию. Вопросы утилиты настройки такие:
