...
При успешной авторизации с помощью браузера в процессе настройки, - будет отображена форма <a href="#fig44">рис. 4.4</a> уведомляющая об успешно пройденной авторизации.
