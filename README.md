...
> [!NOTE]
> _**Примечание:**
> На рис.2.6 показано уже переименованное, короткое наименование `диска Z` (идентификатор **YD**). Эта операция выполнена из элемента "Сетевой диск", использованием контекстного меню содержащего элемент  **"Переименовать"**._
