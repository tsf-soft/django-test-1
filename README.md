...
На рис. 4.2 видно, что содержимое сетевого диска такое-же, что и содержимое этого же диска, подключенное для варианта <a href="#fig25">OS Windows</a> и для варианта  <a href="#fig35">OS Linux Ubuntu GUI</a>.
