...
На панели инструментов GUI нажать на соответствующий значок (обведен красной рамкой на <a href="#fig31">рис. 3.1</a>). Все дальнейшие действия по подключению Яндекс Диска к компьютеру в этой операционной системе, будем проводить с использованием открывшегося окна приложения "Файлы".
...
В поле "**Подключится к серверу**" (<a href="#fig33">рис. 3.3</a>), введите адрес сервера в формате:
