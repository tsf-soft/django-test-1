...
> - промпт `root@linux-tsf:/home/tsf#` показывающий, что пользователь (tsf) находится в текущем каталоге `/home/tsf`, на компьютере с именем: `linux-tsf:` и имеет полномочия администратора (`root`)._</br>
