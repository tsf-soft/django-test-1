...
> [!NOTE]
> _**Примечание:**
> На рис.2.6 показано уже переименованное, короткое наименование `диска Z` (идентификатор **YD**). Эта операция выполнена из контекстного элемента "Сетевой диск", использованием элемента меню **"Переименовать"**._

Выбранный на <a href="#fig26">рис. 2.6</a> файл "Москва.jpeg" будет реперным элементом, наличие которого в каталоге сетевого диска будет свидетелььствовать о том, что мы подключились к тому-же Яндекс Диску при использовании вариантов подключения с использованием различных операционных системах.
