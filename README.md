...
Выбранный на <a href="#fig26">рис. 2.6</a> файл "Москва.jpeg" будет реперным элементом в рамках этого руководства, наличие которого в каталоге сетевого диска будет свидетелььствовать о том, что мы подключились к тому-же Яндекс Диску при использовании вариантов подключения с использованием различных операционных систем.
