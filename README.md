...
Вопросы безопасности, связанные с регистрируемым аккаунтом, касающиеся требований к паролям, в том числе для доступа к Яндекс Диску, подробно описаны в [этой статье](https://yandex.ru/support/id/authorization/app-passwords.html).
...
![Не возможно подключиться](https://github.com/tsf-soft/django-test-1/assets/6228605/8553b51d-2d75-468f-af41-31b8567fbf70)
...
![[Место установки индивидуального пароля](https://github.com/tsf-soft/django-test-1/assets/6228605/ead7cd5e-ee47-4995-926a-3184540a8a6b)
_<p>Рисунок 1.2. Последовательность элементов меню в Яндекс ID для установки пароля приложения</p>_
...
![Ввод имени пароля приложения](https://github.com/tsf-soft/django-test-1/assets/6228605/7c83cd4c-4a6f-4ce5-8b0c-b4cd4e3e303f)
...
![Собственно пароль приложения](https://github.com/tsf-soft/django-test-1/assets/6228605/9af206e5-1da5-4c15-a0c3-100ac373f2a2)
_<p>Рисунок 1.4. Вкладка №2, - формы создания пароля приложения</p>_

<br/>

В случае успешного создания вами индивидуального пароля для приложения в **Яндекс ID** на ваш адрес электронной почты от службы поддержки Яндекс ID придёт письмо с уведомлением о совершенном действии (<a href="#fig15">рис. 1.5</a>)

<a name="fig15"></a>

![Уведомление от службы поддержки](https://github.com/tsf-soft/django-test-1/assets/6228605/fdbaa57f-5f0d-4a5b-97a8-3c27a0630eb8)
...
![Хранение индивидуального пароля в системе](https://github.com/tsf-soft/django-test-1/assets/6228605/0fc24a3e-c498-4f33-bcec-23dd7356a72b)
...
![Выбор из контекстного меню](https://github.com/tsf-soft/django-test-1/assets/6228605/e316770d-b48c-4bfa-8b61-6b804330db15)
_<p>Рисунок 2.1. Контекстное меню элемента "Мой компьютер" в "Проводнике"</p>_

<br/>

<a name="fig22"></a>

![Выбор из панели инструментов проводника](https://github.com/tsf-soft/django-test-1/assets/6228605/ea29b242-6fae-40c0-83b3-974bddb2c5f8)
...
![Форма "Подключение сетевого диска"](https://github.com/tsf-soft/django-test-1/assets/6228605/3a05900b-9117-49de-95b3-f33b1de24921)
...
![Форма "Безопасность Windows"](https://github.com/tsf-soft/django-test-1/assets/6228605/43e19ca2-2c35-47b5-9021-bb2200aabf09)
...
![Защищённое подключение к сетевому компьютеру](https://github.com/tsf-soft/django-test-1/assets/6228605/0fab1cd5-3b33-4855-b7c5-353e7024d8bb)
...
![Подключенный сетевой диск](https://github.com/tsf-soft/django-test-1/assets/6228605/14f11d43-faa2-4bae-abf9-3831b7c83329)
...
![Приложение "Файлы" Gnome Linux](https://github.com/tsf-soft/django-test-1/assets/6228605/5fca16f0-45fe-43d7-854c-fbd98af5b935)
...
![Доступные местоположения файлов на компьютере](https://github.com/tsf-soft/django-test-1/assets/6228605/355691e2-11a3-4b8a-96fe-6fd842fb7947)
...
После ввода адреса сервера нужно нажать на кнопку "**Подключиться**" (<a href="#fig33">рис. 3.3</a>).

<a name="fig33"></a>

![Элементы интерфейса, связанные с подключением](https://github.com/tsf-soft/django-test-1/assets/6228605/1051fa5a-c650-4ae8-b6e3-bf4d457258f5)
...
![Форма аутентификации](https://github.com/tsf-soft/django-test-1/assets/6228605/47c78066-aecb-4dea-841a-8c51d3ddaf5e)
...
![Содержимое подключенного сетевого диска](https://github.com/tsf-soft/django-test-1/assets/6228605/d1540b15-1ae9-40bc-93d5-465c1cdfe969)
...
![Переименование закладки](https://github.com/tsf-soft/django-test-1/assets/6228605/5e9b78e8-7a88-414e-b742-5bec26cc4adc)
...
![Короткое имя подключенного сетевого диска](https://github.com/tsf-soft/django-test-1/assets/6228605/5f3f5939-ac60-48e0-96e8-03e57c2d32ae)
...
Для подключения к Linux-машине нужно запустить терминал **Bash** на удалённом компьютере. После чего войти в Linux Ubuntu с аккаунтом зарегистрированного в системе пользователя. На <a href="#fig41">рис. 4.1</a> показано окно терминала **Bash**, подключенного к Linux-машине. На рисунке показано, что интерпретатор ожидает ввода команд.
...
![Терминал Bash](https://github.com/tsf-soft/django-test-1/assets/6228605/acfda903-d7f9-4b57-b676-b10d1c67d551)
...
Далее нужно получить открытый ключ шифрования `YANDEX-DISK-KEY.GPG` из репозитория Яндекс Диска, после чего добавить полученный ключ в список надёжных репозиториев. Эти две консольные команды показаны в <a href="#lst42">лист.4.2</a>.
...
```
_<p>Листинг 4.2. Работа с открытым ключом шифрования</p>_

> [!NOTE]
> _**Примечание:**_
> _Команда `apt-key` в настоящее время устарела, поскольку её действие носит глобальный характер, что может сказаться на безопасности, однако её использование не запрещено. Ожидается, что в будущем эта команда будет полностью заменена._
...
Выполнение настройки параметров подключаемого Яндекс Диска производим командой <a href="#lst45">лист. 4.5</a>. При этом для авторизации в процессе выполнения настройки необходимо воспользоваться веб-браузером на любом доступном устройстве, подключенном к сети Bнтернет (<a href="#fig43">рис. 4.3</a>).
...
![Настройки консольного клиента в системе](https://github.com/tsf-soft/django-test-1/assets/6228605/9861d39d-b04f-4dd9-bbec-b13ff190e9ad)
...
![Форма авторизации в браузере](https://github.com/tsf-soft/django-test-1/assets/6228605/bead7469-5ec0-4795-a03c-66d903e76706)
...
![Успешно пройденная авторизация](https://github.com/tsf-soft/django-test-1/assets/6228605/5439e53d-b576-4705-881e-ecef8019a988)
_<p>Рисунок 4.4. Успешно пройденная авторизация</p>_

> [!NOTE]
> _**Примечание:**_
> _Авторизация в браузере будет произведена в текущем активном аккаунте Яндекс ID пользователя. Иначе говоря, вы подключите тот экземпляр Яндекс Диска, который привязан к вашему текущему активному аккаунту. Если вам нужен другой экземпляр Яндекс Диска, то измените текущий активный аккаунт путём авторизации в нужном аккаунте, после чего выполняйте авторизацию._
...
![Несколько подключенных аккаунтов Яндекс Диска](https://github.com/tsf-soft/django-test-1/assets/6228605/d434bbcb-7d46-4631-a85f-50e9dc89429b)
