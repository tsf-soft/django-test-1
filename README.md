...
Созданный вами индивидуальный пароль приложения храниться в системе в зашифрованном виде. Код пароля, в т.ч. в случае вашего обращения в службу поддержки, вы можете посмотреть открыв пункт с именем созданного вами пароля (<a href="#fig5">рис. 5</a>).
...
_<p>Рисунок 5. Хранение индивидуального пароля в системе</p>_
